...
var uiController = (function () {
    ...
    return {
        ...
        getInputData: function () {
            ...
            var markup, element;
            var item = budgetController.getBudget();
            console.log(item);
            ...
            item[type].forEach((cur)=>{
                newHTML = markup.replace("%id%", cur.id);
                newHTML = newHTML.replace("%description%",cur.desc);
                newHTML = newHTML.replace("%value%", formatNumber(cur.value, type));
            })
